/* 前晋四 · 浏览器端价表解析器
   复用内网 parser_xlsx.py / Node 函数版逻辑，纯前端运行（依赖全局 XLSX，由 admin.html 从 CDN 载入）。
   仅做解析，不涉及网络；输出结构与内网 prices.json 完全一致，供 Engine 与公网站使用。 */
(function (global) {
  ...
  global.QuoteParser = { parseWorkbook };
})(window);
